...
async def myplan(client, message):
    ...
    if data and data.get("expiry_time"):
        ...
        await message.reply_text(f"<blockquote><b>⚡ Group ⚡\n\nᴛɪᴍᴇ ʟᴇꜰᴛ - {time_left_str}\nᴇxᴘɪʀᴇ ᴛɪᴍᴇ - {expiry_str_in_ist}</b></blockquote>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Uᴘɢʀᴀᴅᴇ", url="https://te.legra.ph/Premium-Plan-11-07"), InlineKeyboardButton("Cʟᴏsᴇ ❌", callback_data="close_data")]])) 
    else:
...
#         ],[
#             InlineKeyboardButton('ʜᴏᴡ ɪᴛs ᴡᴏʀᴋ', url="https://te.legra.ph/Premium-Plan-11-07"),
#             InlineKeyboardButton('cʟᴏꜱᴇ', callback_data='close_data')
#         ]]
#     await message.reply_photo(
#         photo="https://te.legra.ph/file/24dbc27aa81f89daf61fc-82960afc3f1fffa73c.jpg",
...
async def allplan(bot, message):
    btn = [[
            ...
            InlineKeyboardButton('☘️ ꜰᴜᴛᴜʀᴇ ☘️', url="https://te.legra.ph/Premium-Plan-11-07"),
            InlineKeyboardButton('cʟᴏꜱᴇ', callback_data='close_data')
        ]]
    await message.reply_photo(
        photo="https://te.legra.ph/file/24dbc27aa81f89daf61fc-82960afc3f1fffa73c.jpg",
        caption="""<blockquote><b>
        <a href='@thewarriorsreal'>💥 ᴘʀᴇᴍɪᴜᴍ  💥
        💥 💫 Premium Features For Bot
